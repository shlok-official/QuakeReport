...
public class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeList> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < featuresArray.length(); i++){
                JSONObject first = featuresArray.getJSONObject(i);
